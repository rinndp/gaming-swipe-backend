...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    password = models.CharField(max_length=155, null=False, blank=False, verbose_name="Password")
    image = models.ImageField(upload_to="profile_pictures", null=True, blank=True, verbose_name="Imagen")
