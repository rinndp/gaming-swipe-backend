...
urlpatterns = [
    ...
    path("favgames/delete/<str:slug>/<int:id_api>", DeleteFavGameView.as_view(), name="delete-favgame"),
    path("favgames-played/delete/<str:slug>/<int:id_api>", DeletePlayedGameView.as_view(), name="delete-favgame-played"),
